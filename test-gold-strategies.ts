#!/usr/bin/env tsx
/**
 * Test both SMA Crossover and Mean Reversion strategies on Micro Gold (MGC)
 * Full October 2025
 */
...
const CONTRACT_ID = 'CON.F.US.MGC.Z25';  // Micro Gold
const START_DATE = '2025-10-01T00:00:00Z';
const END_DATE = '2025-10-31T23:59:59Z';
const COMMISSION = 0.52;  // Micro Gold commission per side

async function runGoldBacktests() {
  console.log('\n' + '='.repeat(80));
  console.log('MICRO GOLD (MGC) STRATEGY BACKTESTS - OCTOBER 2025');
  ...
  console.log('\n' + '='.repeat(80));
  console.log('MICRO GOLD BACKTESTS COMPLETE');
  console.log('='.repeat(80));
}

runGoldBacktests().catch(console.error);
