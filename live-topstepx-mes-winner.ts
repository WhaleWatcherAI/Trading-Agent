#!/usr/bin/env tsx
/**
 * TopstepX Live MES Winner Strategy - ENHANCED VERSION
 *
 * Features:
...
const DASHBOARD_PORT = Number(process.env.TOPSTEPX_NQ_DASHBOARD_PORT || '3334');
...
async function main() {
  console.log('\n' + '='.repeat(80));
  console.log('TOPSTEPX LIVE MES WINNER STRATEGY - ENHANCED VERSION');
