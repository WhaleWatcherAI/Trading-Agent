#!/usr/bin/env python3
"""
Train baseline models on last 3 months and save.
...
def main():
    print("=" * 70)
    print("TRAINING BASELINE MODELS (LAST 3 MONTHS, NO L2)")
    print("=" * 70)
    ...
    # Last 3 months = last ~75 trading days
    train_dates = dates[-75:]
    print(f"\n[2/5] Training on last 3 months: {train_dates[0]} to {train_dates[-1]}")
    print(f"Total training days: {len(train_dates)}")
    ...
    # Save models
    save_dir = "ml/models/baseline_3month_no_l2"
