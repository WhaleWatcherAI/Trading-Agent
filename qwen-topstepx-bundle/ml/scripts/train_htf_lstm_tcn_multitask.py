#!/usr/bin/env python3
"""
Long-Term Multi-Timeframe LSTM + TCN - MULTI-TASK LEARNING
...
def main():
    print("="*70)
    print("HYBRID LSTM + TCN MULTI-TASK TRAINING")
    print("="*70)
    ...
    }, os.path.join(output_dir, 'htf_lstm_tcn_multitask.pt'))
    ...
    print(f"\nModel saved to: {output_dir}/htf_lstm_tcn_multitask.pt")
