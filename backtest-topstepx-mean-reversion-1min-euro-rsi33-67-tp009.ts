...
const CONFIG: BacktestConfig = {
  ...
  takeProfitPercent: Number(process.env.TOPSTEPX_MR_TAKE_PROFIT_PERCENT || '0.009'),
  ...
  trailingStopPercent: Number(process.env.TOPSTEPX_MR_TRAILING_STOP_PERCENT || '0.009'),
