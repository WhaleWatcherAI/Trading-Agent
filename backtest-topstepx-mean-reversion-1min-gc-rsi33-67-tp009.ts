...
const DEFAULT_MR_SYMBOL = process.env.TOPSTEPX_MR_SYMBOL || 'GCZ5';
...
const CONFIG: BacktestConfig = {
  ...
  takeProfitPercent: Number(process.env.TOPSTEPX_MR_TAKE_PROFIT_PERCENT || '0.0009'),
...
async function runBacktest() {
  ...
  for (let i = 0; i < bars.length; i++) {
    ...
    if (position) {
      ...
      // Middle Band Exit - EXIT ALL CONTRACTS (DISABLED FOR GOLD - USE PERCENTAGE TP ONLY)
