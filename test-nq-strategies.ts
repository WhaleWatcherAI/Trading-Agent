#!/usr/bin/env tsx
/**
 * Test both SMA Crossover and Mean Reversion strategies on Micro NASDAQ (MNQ)
 * Full October 2025
 */
...
const CONTRACT_ID = 'CON.F.US.MNQ.Z25';  // Micro NASDAQ
const START_DATE = '2025-10-01T00:00:00Z';
const END_DATE = '2025-10-31T23:59:59Z';
const COMMISSION = 0.37;  // Micro NQ commission per side

async function runNQBacktests() {
  console.log('\n' + '='.repeat(80));
  console.log('MICRO NASDAQ (MNQ) STRATEGY BACKTESTS - OCTOBER 2025');
  ...
  console.log('\n' + '='.repeat(80));
  console.log('MICRO NASDAQ BACKTESTS COMPLETE');
  console.log('='.repeat(80));
}

runNQBacktests().catch(console.error);
